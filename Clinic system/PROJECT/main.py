...
app.config.update(
    ...
    MAIL_PORT='465',
    MAIL_USE_SSL=True,
    MAIL_USERNAME="inhousetestbp1@gmail.com",
    MAIL_PASSWORD="Bis_Ani1"
)
mail = Mail(app)
...
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql://root:@localhost/hms14'
db = SQLAlchemy(app)
...
def patient():
    ...
    if request.method == "POST":
        ...
        mail.send_message(subject, sender=["inhousetestbp1@gmail.com", "Bis_Ani1"], recipients=[
            email], body=f"YOUR bOOKING IS CONFIRMED THANKS FOR CHOOSING US \nYour Entered Details are :\nName: {name}\nSlot: {slot}")
